...
class Step3ContactsForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text(
          'Daftarkan penanggung jawab (PIC) pelanggan. Minimal harus ada 1 PIC yang bertindak sebagai Pengambil Keputusan.',
                ...
                _buildFieldGrid3(
                  ...
                  c3: _buildDropdownField<String>(
                    ...
                    items: roleOptions
                        ...
                        .toList(),
                    onChanged: (v) {
                      final selected = CustomerContactRole.fromString(v ?? 'pic');
                      controller.updateContact(
                        index,
                        item.copyWith(
                          role: selected.value,
                          roleBadge: selected.badgeType,
