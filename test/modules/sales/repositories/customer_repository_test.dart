...
void main() {
  ...
  group('CustomerRepository - getCustomerById', () {
    test('getCustomerById returns full customer detail with locations, contacts, proposals',
        () async {
  ...
  group('CustomerRepository - createCustomer', () {
    test('createCustomer sends matching contract body and receives basic customer entity',
        () async {
      mockAdapter.handler = (options) {
        expect(options.path, '/v1/sales/customers');
        ...
        expect(locations.first['address_line'], 'Jl. Menteng Raya No. 42, Jakarta Pusat');
